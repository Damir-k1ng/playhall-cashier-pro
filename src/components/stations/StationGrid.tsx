      ...
      <div className="space-y-5 sm:space-y-6 lg:space-y-8">
        ...
        <section>
          <div className="flex items-center gap-2.5 sm:gap-3 mb-3 sm:mb-4 lg:mb-5">
            ...
            <h2 className="text-[10px] sm:text-xs lg:text-sm font-bold text-vip uppercase tracking-[0.15em] sm:tracking-[0.2em]">
              VIP Зона
            </h2>
        ...
        <section>
          <div className="flex items-center gap-2.5 sm:gap-3 mb-3 sm:mb-4 lg:mb-5">
            ...
            <h2 className="text-[10px] sm:text-xs lg:text-sm font-bold text-primary uppercase tracking-[0.15em] sm:tracking-[0.2em]">
              Зал
            </h2>
